...
const padletStyles = [
  'rotate-[-1deg] bg-gradient-to-br from-amber-50 to-orange-100 border-amber-200 dark:from-amber-950/40 dark:to-orange-950/30 dark:border-amber-800/60',
  'rotate-[1deg] bg-gradient-to-br from-cyan-50 to-sky-100 border-cyan-200 dark:from-cyan-950/40 dark:to-sky-950/30 dark:border-cyan-800/60',
  'rotate-[-2deg] bg-gradient-to-br from-emerald-50 to-teal-100 border-emerald-200 dark:from-emerald-950/40 dark:to-teal-950/30 dark:border-emerald-800/60',
  'rotate-[2deg] bg-gradient-to-br from-fuchsia-50 to-pink-100 border-fuchsia-200 dark:from-fuchsia-950/40 dark:to-pink-950/30 dark:border-fuchsia-800/60',
];
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7 dark:border-slate-800 dark:bg-slate-900">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
              <span className="rounded-full border border-cyan-200 bg-cyan-100/80 px-2 py-1 text-cyan-800 dark:border-cyan-800/60 dark:bg-cyan-950/40 dark:text-cyan-300">
                Public board: no login required
              </span>
            </p>
            <h2 className="mt-1 text-2xl font-black text-slate-900 sm:text-3xl dark:text-white">Community Idea Padlet</h2>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.05fr,0.95fr]">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5 dark:border-slate-700 dark:bg-slate-800/60">
            <p className="text-sm font-bold text-slate-900 dark:text-white">Post a New Idea</p>
            <div className="mt-3 space-y-3">
              <input
                ...
                className="min-h-[46px] w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm outline-none transition focus:border-slate-500 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-slate-400"
              />
              <textarea
                rows={4}
                value={ideaText}
                ...
                className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm outline-none transition focus:border-slate-500 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-slate-400"
              />
              <div className="flex flex-wrap items-center gap-3">
                <button
                  ...
                  className="w-full rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white"
                >
                  {padletSaving ? 'Pinning...' : 'Pin Idea'}
                </button>
                {ideaError ? <p className="text-sm font-medium text-rose-600 dark:text-rose-400">{ideaError}</p> : null}
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {padletLoading ? (
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600 sm:col-span-2 dark:border-slate-700 dark:bg-slate-800/60 dark:text-slate-400">
                Loading ideas...
              </div>
            ) : null}
            ...
            {pins.slice(0, HOME_PADLET_LIMIT).map((pin, index) => (
              ...
              >
                <span className="absolute -top-2 left-6 inline-flex h-4 w-4 rounded-full border border-white bg-slate-700 shadow dark:border-slate-900 dark:bg-slate-300" />
                <p className="pr-2 text-sm leading-6 text-slate-800 dark:text-slate-200">{pin.idea}</p>
            ...
            {!padletLoading && pins.length > HOME_PADLET_LIMIT ? (
              <div className="sm:col-span-2 flex flex-wrap items-center gap-3 pt-2">
                <span className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-slate-600 dark:border-slate-700 dark:bg-slate-800/60 dark:text-slate-400">
